...
public class GajiMain {
	public static void main(String[] args) {
		GajiPelatih gpe1=new GajiPelatih(2000000,10000000);
		System.out.println("Gaji Pelatih : " + gpe1.hitungGaji());
		
		int bonusMenang=10000000;
		int bonusGol=500000;
		
		GajiPemain gpem1=new GajiPemain(8000000,bonusMenang,bonusGol);
		GajiPemain gpem2=new GajiPemain(1000000,bonusMenang,bonusGol);
		GajiPemain gpem3=new GajiPemain(5000000,bonusMenang,bonusGol);
		
		Pemain pemain1 = new Pemain("Febri Haryadi",22,gpem1);
